// Configuración de la API - Cambiar esta URL por la de tu backend en Render
const API_BASE_URL = 'https://tu-backend-render.onrender.com'; // Cambiar por tu URL de Render
